...
- [x] **SUBMIT-02**: New submissions are pending and invisible on public views until approved
...
- [x] **GAP-02**: User can view observable-but-unclaimed dates for a campaign target + site; computed on explicit request or cached, never inline in the table view, never importing `ephem_utils` at module scope
