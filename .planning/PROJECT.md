...
---
*Last updated: 2026-07-15 — Phase 22 (site matching at submission and unmatched-site resolution workflow) complete: live HTMX fuzzy site search on the public submission form and approval queue, plus a "Sites needing review" resolution surface for approved runs with unresolved sites, including placeholder-Observatory correction. 6/6 plans (3 original + 3 gap-closure) executed; human UAT found and closed 3 real browser-only bugs; a follow-up deep review found and fixed 2 further Critical issues the placeholder-correction feature exposed one layer down. 495/495 tests pass. This was the actual last phase of v2.1 Uncertain Scheduling & Site Disambiguation — all target features shipped; milestone close (`/gsd-complete-milestone`) not yet run.*
