...
- [ ] 20-01-PLAN.md — Asset-aware coverage gap: `claimed_dates()` ground-vs-space branch + `pending_narrowing_runs` bucket + gap-page alert (ASSET-01/02, D-09/D-10)
- [ ] 20-02-PLAN.md — Schema: `original_obs_date_raw` + `window_needs_review` fields + migration 0006 + TBD-badge tooltip (D-01/D-02/D-04/D-08)
...
| 20. Range/TBD Import & Asset-Aware Coverage Gap | v2.1 | 0/4 | Planned | - |
