...
updated: 2026-06-25T13:50:00Z
---

## Current Test

number: 1
name: Visual perceptibility of the dashed border on a rendered calendar page
expected: |
  The fallback event's block shows a visibly dashed border distinct from
  neighboring solid-bordered/unstyled events, perceivable at a normal glance
  without opening the event or reading its (often truncated) title.
