...
- test: 2
  decision: "Option A — narrow the 33-09/33-05 prohibition: `source` is the provenance enum (CampaignRun.Source), not contact data, and is dropped from the must-NOT. The prints in campaign_lifecycle_demo.ipynb cells In[5], In[6], In[10], In[11], In[17] (0-based indices 10, 12, 20, 22, 34 — 33-VERIFICATION.md's 'cells 10, 12' are these indices) stay as they are. The contact_person/contact_email half of the prohibition remains in force and is confirmed closed."
