...
| 35-01-02 | 35-01 | 1 | ALLOC-03 | T-35-03 | link retires the night, unlink restores it, observation event byte-unchanged, foreign human-confirmed attribution refused | unit | `python manage.py test solsys_code.tests.test_allocation_projector` | ❌ W0 (created by 35-01-01) | ⬜ pending |
...
| 35-02-01 · 35-02-02 · 35-02-03 | 35-02 | 2 | ALLOC-01, ALLOC-03 | T-35-09 | the existing suite states the new dispatch and the new key families; no retired test is dropped without a destination or a reason | unit + integration | `LABELS=$(ls solsys_code/tests/test_*.py solsys_code/solsys_code_observatory/tests/test_*.py \| grep -v "tests/test_views\.py$" \| sed "s\|/\|.\|g; s\|\.py$\|\|" \| tr "\n" " "); python manage.py test $LABELS` | ✅ | ⬜ pending |
