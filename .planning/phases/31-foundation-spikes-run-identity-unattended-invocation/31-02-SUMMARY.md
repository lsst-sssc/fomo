...
key-decisions:
  ...
  - "SCHEMA-02: a new source_identifier CharField(max_length=255, null=True, blank=True) with a partial UniqueConstraint (condition=source_identifier__isnull=False) is proposed as an additive identity surface, disjoint by field set from both existing partial constraints, confirmed empirically to coexist without disturbing either."
