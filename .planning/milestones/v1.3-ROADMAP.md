...
- ✅ **v1.0 Site/Ephemeris Helper** — Phase 1 (shipped 2026-06-14) — see [1.0-ROADMAP.md](1.0-ROADMAP.md)
- ✅ **v1.1 Classical Run Ingest** — Phases 2-3 (shipped 2026-06-16) — see [v1.1-ROADMAP.md](v1.1-ROADMAP.md)
- ✅ **v1.2 LCO Queue Calendar Sync** — Phase 4 (shipped 2026-06-18) — see [v1.2-ROADMAP.md](v1.2-ROADMAP.md)
- 🔄 **v1.3 Full LCO Facility Sync** — Phases 5-7 (in progress)
...
- [ ] **Phase 6: Correct Instrument-Type Extraction** - The command extracts the real instrument type from multi-configuration parameter shapes (SOAR's spectrum/arc/lamp-flat, LCO MUSCAT's per-channel keys), never mistaking a calibration config for the science one
- [ ] **Phase 7: Live Telescope-Label Resolution with Fallback & Failure Reporting** - Placed records get a verified site/telescope label resolved via a per-record LCO API call against a verified 8-site dict, falling back to a coarse instrument-class label (with visible, counted, non-fatal degrade) when that call fails
