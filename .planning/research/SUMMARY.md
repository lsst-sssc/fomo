...
- Django Model field reference (5.2), Django one-to-one relationships docs, Django QuerySet API reference
- Free/Busy slashed lines -- Microsoft Support (official confirmation of the diagonal-stripe-for-tentative convention)
- Making data visualizations accessible -- TPGi (WCAG 2.1 SC 1.4.1 citation)

### Secondary (MEDIUM confidence)
- eventColor / event-colors-demo -- FullCalendar docs; How to Color Code Google Calendar
- colorhash on PyPI -- basis for rejecting raw hash-to-HSL
- Stripes in CSS -- CSS-Tricks -- `repeating-linear-gradient` feasibility
